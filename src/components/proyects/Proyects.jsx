    ...
    <div className='container' >
      ...
      <div className="proyects" id='proyects-rev'>
        <div className='proyects_info'>
          ...
          <p id=''>{data.Stack2 }</p>
          <a target='_blank' href="https://carlosreactshop.netlify.app/"><button>{data.BotonProyects }</button></a>
        </div>
        <div className='proyects_img'>
      ...
      <div className="proyects">
        ...
        <div className='proyects_info'>
          <p >Titulo: {data.tituloProyecto3}</p>
          <p >Empresa: {data.Empresa3}</p>
      ...
      <div className="proyects" id='proyects-rev'>
        <div className='proyects_info'>
          <p id=''>Titulo: {data.tituloProyecto4}</p>
          <p id=''>Empresa: {data.Empresa4}</p>
          <p id=''>{data.Descripcion4}</p>
          <p id=''>{data.Stack4 }</p>
